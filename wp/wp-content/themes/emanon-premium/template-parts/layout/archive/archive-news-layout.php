<?php
/**
 * Template part for layout in archive-news.php
 *
 * @since 1.0.0
...
$col                 = get_theme_mod( 'archive_news_layout','two-r-col' );
...
<div id="contents">
	<?php
		if ( ! is_paged() && 'taxonomy_term_header_full_width' === $header_style ) {
			get_template_part( 'template-parts/parts/featured-image/archive/news/news-header-full-width' );
		} elseif ( ! is_paged() && 'taxonomy_term_header_full_width_overlay' === $header_style ) {
			get_template_part( 'template-parts/parts/featured-image/archive/news/news-header-full-width-overlay' );
		}
	?>
	<div class="l-content">
		<?php
		...
		<div class="l-content__inner">
			...
			<?php
				get_template_part( 'template-parts/content/archive/content-news' );
			?>
			</main>
			<?php
				if ( 'one-col' !== $col ) {
