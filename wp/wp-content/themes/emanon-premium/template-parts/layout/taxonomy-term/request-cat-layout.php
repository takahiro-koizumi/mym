...
<div id="contents">
	<?php
		if ( ! is_paged() && 'taxonomy_term_header_full_width' === $header_style ) {
			get_template_part( 'template-parts/parts/featured-image/taxonomy-term/request/request-term-header-full-width' );
		} elseif ( ! is_paged() && 'taxonomy_term_header_full_width_overlay' === $header_style ) {
			get_template_part( 'template-parts/parts/featured-image/taxonomy-term/request/request-term-header-full-width-overlay' );
		}
	?>
	<div class="l-content">
		<?php
