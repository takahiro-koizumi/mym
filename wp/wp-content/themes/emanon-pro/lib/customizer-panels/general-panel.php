...
*/
	...
	'title' => __( 'General settings', 'emanon' ),
		...
		$wp_customize->add_section( 'emanon_meta_tages', array (
			...
			// Remove sitemap
			$wp_customize->add_setting( 'remove_sitemap', array (
				'default' => true,
				'type' => 'theme_mod',
				'sanitize_callback' => 'emanon_customize_sanitize_checkbox',
			) );
			$wp_customize->add_control( 'remove_sitemap', array(
				'label' => __( 'Remove sitemap', 'emanon' ),
				'description' => __( 'Stop the standard WordPress feature XML sitemap.', 'emanon' ),
				'section' => 'emanon_meta_tages',
				'settings' => 'remove_sitemap',
				'type' => 'checkbox',
				'priority' => 4,
			) );
		...
		/* Facebook OGP
		/*----------------------------------------------------------------------------------*/
		$wp_customize->add_section( 'emanon_facebook_ogp_options', array (
			'title'	 => __( 'Facebook OGP tag', 'emanon'),
			'priority' => 2,
			'panel' => 'emanon_general_settings',
		) );

			// Facebook OGP
			$wp_customize->add_setting( 'display_facebook_ogp', array(
				'default' => '',
				'type' => 'theme_mod',
				'sanitize_callback' => 'emanon_customize_sanitize_checkbox',
			) );
			$wp_customize->add_control( 'display_facebook_ogp', array(
				'label' =>__( 'Display facebook ogp meta tag', 'emanon' ),
				'section' => 'emanon_facebook_ogp_options',
				'settings' => 'display_facebook_ogp',
				'type' => 'checkbox',
				'priority' => 1,
			) );
			...
			// Facebook OGP image
			$wp_customize->add_setting( 'facebook_ogp_image', array(
				'default' => '',
				'type' => 'theme_mod',
				'sanitize_callback' => 'esc_url_raw',
			) );
			$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'facebook_ogp_image', array (
				'label' => __( 'Facebook OGP image', 'emanon' ),
				'section' => 'emanon_facebook_ogp_options',
				'settings' => 'facebook_ogp_image',
				'priority' => 3,
			) ) );
		...
		$wp_customize->add_section( 'emanon_twitter_card_options', array (
			...
			// Twitter OGP image
			$wp_customize->add_setting( 'twitter_ogp_image', array(
				'default' => '',
				'type' => 'theme_mod',
				'sanitize_callback' => 'esc_url_raw',
			) );
			$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'twitter_ogp_image', array (
				'label' => __( 'Twitter OGP image', 'emanon' ),
				'section' => 'emanon_twitter_card_options',
				'settings' => 'twitter_ogp_image',
				'priority' => 4,
			) ) );
